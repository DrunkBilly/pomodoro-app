...
const settingsButtonElement = document.querySelector('.settings-button object');
const settingsMenu = document.querySelector('.settings-menu');
const settingClose = document.querySelector('.setting-close');
const settingPomodoro = document.getElementById('pomodoro');
const settingShortBreak = document.getElementById('short-break');
const settingLongBreak = document.getElementById('long-break');
...
function showHideRestart(mode) {
    ...
    if (currentSeconds === 59 && currentMinutes === -1)
        return;
    if (mode)
        return;
    (pause) ?
